 ...
 */
public class Type3ViewHolder_Plus extends TypeAbstractViewHolder_Plus<DataModel3> {
    ...
    public Type3ViewHolder_Plus(View itemView) {
        super(itemView);
    ...
    @Override
    public void bindHolder(DataModel3 model) {
